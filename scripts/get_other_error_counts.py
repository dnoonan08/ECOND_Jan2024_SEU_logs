...
for hexaNumber in hexacontrollers:
    ...
    for fname in fileNames:
        ...
        try:
            if regNames is None:
                regNames=data['tests'][testNumber]['metadata']['other_register_err_names']
            errCounts=data['tests'][testNumber]['metadata']['other_register_err_cnts']
...
df.to_csv('../data/other_error_counts_by_run.csv',index=False)
